    ...
    <div name="home" className="w-full mb-[25vh] bg-[#0a192f]">
      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        ...
        <p className="text-[#8892b0] py-4 max-w-[700px]">
          ...
          aliquam saepe perspiciatis assumenda deserunt, quisquam explicabo quas
          cum ratione molestiae doloribus voluptas voluptatibus. Labore, soluta
          alias! Ipsam sequi facilis pariatur?
        </p>
        <div>
